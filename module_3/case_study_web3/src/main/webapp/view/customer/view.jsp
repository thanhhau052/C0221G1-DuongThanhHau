        ...
        <div class="col-6 d-flex flex-column">
            ...
            <form  class="container border border-dark mb-3 pt-3">
                <div class="form-group">
                    <label>ID:</label>
                    <input type="text" class="form-control" name="customer_id" value="${customer.customerId}">
                </div>
                <div class="form-group">
                    <label>Type ID: </label>
                ...
                <div class="form-group">
                    <label>Gender: </label>
                    <input type="text" class="form-control " name="customer_gender" value="${customer.customerGender}">
                </div>
                <div class="form-group">
                    <label>ID Card: </label>
